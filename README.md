...
Ingestão: Axum → Rust structs (serde).

Validação: amazon.com whitelisted? click permitido?

Execução: CDP Worker clica #buy.

Observability: Extrai Accessibility Tree compactada.

Retorno: Sucesso + novo estado para LLM.
